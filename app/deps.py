...
def verify_bearer(session: SessionDep, credentials: HTTPAuthorizationCredentials | None = None) -> str:
    """
    ...
    """
    strict_credentials: HTTPAuthorizationCredentials = credentials or Depends(HTTPBearer())
    token = strict_credentials.credentials
