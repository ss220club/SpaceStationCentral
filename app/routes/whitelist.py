...
@router.post("/{wl_type}/ckey", status_code=status.HTTP_201_CREATED, dependencies=[Depends(verify_bearer)])
...
@router.post("/{wl_type}/discord", status_code=status.HTTP_201_CREATED, dependencies=[Depends(verify_bearer)])
